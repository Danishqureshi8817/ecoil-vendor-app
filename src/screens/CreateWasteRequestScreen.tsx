...
import {StackNav, type RootStackParamList} from '@/navigations/NavigationKeys';
...
type Props = NativeStackScreenProps<
  RootStackParamList,
  typeof StackNav.CreateWasteRequest
>;
...
export default function CreateWasteRequestScreen({route}: Props) {
  ...
  const editRequestKey = editRequest
    ? wasteCollectionId(editRequest) || 'edit'
    : 'new';
  ...
  const handleBack = useCallback(() => {
    navigate(StackNav.WasteRequests);
  }, []);
  ...
  return (
    <Container fullScreen statusBarStyle="light-content">
      <AppBar
        title={isEdit ? 'Edit Waste Request' : 'New Waste Request'}
        leading="back"
